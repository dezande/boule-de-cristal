...
const ASSETS = [
	...
	'./index.html',
	'./style.css',
	// Modules de l'app : un fichier .js par fichier .ts de src/, dans les mêmes dossiers
	// (un oubli est signalé au build par scripts/check-dist.ts).
	'./app.js',
	'./logic/gestures.js',
	'./logic/settings.js',
	'./logic/zone-logic.js',
	'./rehearsal/diagnostic.js',
	'./rehearsal/hold-timer.js',
	'./rehearsal/test-mode.js',
	'./settings/panel.js',
	'./settings/store.js',
	'./stage/ball.js',
	'./stage/dust.js',
